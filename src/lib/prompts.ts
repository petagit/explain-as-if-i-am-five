...
export const LEVELS: LevelConfig[] = [
  {
    ...
    label: "5 Year Old",
    shortLabel: "5yo",
    prompt: `You are explaining to a 5-year-old child. Use:
...
- Questions to keep them engaged ("You know how...")`,
  },
  {
    ...
    label: "10 Year Old",
    shortLabel: "10yo",
    prompt: `You are explaining to a 10-year-old child. Use:
...
- References to things they might learn in elementary school`,
  },
  {
    ...
    label: "High School",
    shortLabel: "HS",
    prompt: `You are explaining to a high school student (ages 14-18). Use:
...
- Connections to subjects they study (biology, physics, history, etc.)`,
  },
  {
    ...
    label: "College",
    shortLabel: "College",
    prompt: `You are explaining to a college/university student. Use:
...
- Connections to broader academic disciplines`,
  },
  {
    ...
    label: "Graduate",
    shortLabel: "Grad",
    prompt: `You are explaining to a graduate student or advanced learner. Use:
...
- References to seminal works and contemporary developments`,
  },
  {
    ...
    label: "Expert",
    shortLabel: "Expert",
    prompt: `You are explaining to a domain expert or professional. Use:
